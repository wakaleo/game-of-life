 ...
 */
public class WaitingAccountVo extends BaseDataEntity<WaitingAccountVo> implements Serializable {
	...
	@ExcelField(title = "预计结算日期", align = 2, sort = 1)
	...
	@ExcelField(title = "待结算收入（元）", align = 2, sort = 3)
