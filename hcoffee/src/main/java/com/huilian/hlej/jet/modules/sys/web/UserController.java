...
import com.huilian.hlej.jet.common.beanvalidator.BeanValidators;
...
import com.huilian.hlej.jet.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
  ...
  public String form(User user, Model model) {
    ...
    List<Channel> clist = vendingMachineService.getChannel();
  ...
  public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
    ...
    if (StringUtils.isBlank(user.getId())) {
    	...
    	/*	user.setDelFlag("0");
    	  user = UserUtils.getByLoginName(user.getLoginName());
    	if(user!=null){
...
//	}
      ...
      */
	  @RequiresPermissions("sys:user:view")
	  @RequestMapping(value = {"isDistrictLoginName"})
	  public void isDistrictLoginName(HttpServletRequest request,HttpServletResponse response, Model model) {
