...
<title>代理商图片上传</title>
    ...
    <script src="${pageContext.request.contextPath}/static/plugin/sbb/js/bootstrap.min.js"></script> 
    <script type="text/javascript">
    	$(function(){
    		$(".file-drop-zone-title").html("请上传图片");
    	});
    </script>
</head>
<body>
<div class="container kv-main">
 <form enctype="multipart/form-data">
     <div class="form-group">
         <input id="file_img" class="file" type="file" name="file" multiple>
     </div>
 </form>
</div>
</body>
<script type="text/javascript">
$("#file_img").fileinput({
    uploadUrl: '${ctx}/hcf/dealerManagerment/fileUpload?type=1&loginName=${loginName }',
