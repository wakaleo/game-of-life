	...
	<script type="text/javascript">
		$(document).ready(function() {
 			$("#btnSubmit").click(function(){
				$("#pageNo").val(1);
				$("#searchForm").attr("action","${ctx}/hcf/activityTemplatet/revomList");
				$("#searchForm").submit();
			});
...
<body>
	<form:form id="searchForm" modelAttribute="vendingMachineVo" action="${ctx}/hcf/activityTemplatet/revomList" method="post" class="breadcrumb form-search">
		...
		<table id="tab" class="table table-striped table-bordered table-condensed" style="width: 100%">
			<label >
					<input type="button" class="btn btn-primary" name="returnSubmit" value="返回撤销页面" onclick=" window.history.back();"/>
			</label>
				&nbsp &nbsp &nbsp
			       当前总计： ${pages}
				<%-- <label >
