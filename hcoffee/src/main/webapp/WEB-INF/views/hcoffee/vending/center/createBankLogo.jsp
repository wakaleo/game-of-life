...
<script type="text/javascript">
	...
	$(function(){
		$("#btnsave").click(function(){
			var id = $("#id").val();
			var url = '${ctx}/hcf/bankLogo/save';
			if (id != '' && id != undefined) {
				url = '${ctx}/hcf/bankLogo/update';
			}
			var form = new FormData(document.getElementById("logoAdForm"));
			form.id = id;
			loading('正在提交，请稍等...');
			$.ajax({
		       	 type:'post',
	...
	function UpladFile1(file) {
	   var reader = new FileReader();
		...
		var FileController = "${ctx}/hcf/bankLogo/uploadFile" // 接收上传文件的后台地址 
		// FormData 对象
...
<form:form id="logoAdForm" modelAttribute="bankLogoVo"
	action="${ctx}/hcf/bankLogo/save" method="post"
	...
	<div class="form-horizontal">
		...
		<span id="progressPercent" style="width: 40px; display: none; margin-left: 200px">0%</span>
		<div class="pure-g" id="imgButton" style="display: none">
			<div class="pure-u-2-3">
				<div class="control-group" style="margin-left: 200px">
					<a href="javascript:;" class="file"
						style="margin-left: 20px; border-left-style: solid;">选择银行Logo<input
		...
		<div class="pure-g">
			<div class="pure-u-2-3">
				<div class="control-group">
					...
					<form:select path="bankCode" class="input-xlarge required" style="width:150px;" id="bankCode">
