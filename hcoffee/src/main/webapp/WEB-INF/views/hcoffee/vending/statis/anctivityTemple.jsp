				...
				$("#btnsave").bind("click",function(){
					  ...
					  var data = {}; 
					   ...
					   if($("#templateIds").val()==''){
					    ...
					    data.templateId=$("#templateIds").val();
					    ...
					    var  url ='${ctx}/hcf/activityTemplatet/save';
					    if(data.id!=''){
					    	   url ='${ctx}/hcf/activityTemplatet/update';
					    }
						$.ajax({
					       	 type:'post',
					       	 url:url,
	...
	<div class="pure-g">
				<div class="pure-u-2-3">
					<div class="control-group">
						...
						<div class="controls">
							<input id="template" name="templateName" class="form-control" type="text"  />
						</div>
					</div>
				</div>
			</div>
	<div class="pure-g">
				<div class="pure-u-2-3">
					<div class="control-group">
						...
						<div class="controls">
							<input id="templateIds" name="templateId" class="form-control" type="text"  />
						</div>
					</div>
				</div>
			</div>
