	...
	<script type="text/javascript">
		$(document).ready(function() {
 			$("#btnSubmit").click(function(){
				$("#pageNo").val(1);
				$("#searchForm").attr("action","${ctx}/hcf/activityTemplatet/revokeList");
				$("#searchForm").submit();
			});
		...
		function enable(vendCode,status){
			...
			$.ajax({
				...
				success:function(data){
					alert(data.msg);
		       		if(data.code=="0"){
		       			window.location.href="${ctx}/hcf/activityTemplatet/revokeList";
		       		}
...
<body>
	 <form:form id="searchForm" modelAttribute="vendingMachineVo" action="${ctx}/hcf/activityTemplatet/revokeList" method="post" class="breadcrumb form-search">
	...
	<table class="table table-striped table-bordered table-condensed">
		...
		<tbody>
				...
				<tr>
					...
					<td><a href="${ctx}/hcf/activityTemplatet/revomList?templateId=${templateId}&optionType=${optionType}"    style=" color:#00F; text-decoration:underline; " >设备明细</a></td>
