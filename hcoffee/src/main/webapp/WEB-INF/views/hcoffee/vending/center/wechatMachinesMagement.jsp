	...
	<script type="text/javascript">
		$(document).ready(function() {
 			$("#btnSubmit").click(function(){
				$("#pageNo").val(1);
				$("#searchForm").attr("action","${ctx}/hcf/wechatMaterialModel/sbList");
				$("#searchForm").submit();
			});
		...
		<tbody>
			<c:forEach items="${page.list}" var="model" varStatus="bi">
				<tr>
		            ...
		            <a href="${ctx}/hcf/wechatMaterialModel/sbRecordList?vendCode=${model.vendCode}"    style=" color:#00F; text-decoration:underline; " >模板更新记录</a>
